          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                <button class="btn btn-primary" data-toggle="modal" data-target="#baru">Gallery Baru</a></li>
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    <img src="{{ Storage::url($item->photo) }}"  height="200" alt="...">
                  </div>
                  <div class="row mb-3">
                    ...
                    @csrf
                    @method('DELETE')
                    <button id="delete" class="btn btn-primary" onclick="return confirm('apakah mau hapus?')">hapus</button>
                  </div>
                </form>
